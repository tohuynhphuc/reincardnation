...
@export var min_threshold: Dictionary[String, int] = {
    Constants.SINS_NAME[Constants.SINS.GLUTTONY]: 0,
    Constants.SINS_NAME[Constants.SINS.LUST]: 0,
}

@export var max_threshold: Dictionary[String, int] = {
    Constants.SINS_NAME[Constants.SINS.GLUTTONY]: 100,
    Constants.SINS_NAME[Constants.SINS.LUST]: 100,
}
